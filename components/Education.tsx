...
export default function Education() {
  ...
  // ১. 'never' এরর ফিক্স করতে এখানে HTMLElement টাইপ দেওয়া হয়েছে
  ...
  useEffect(() => {
    // ২. ইভেন্ট অবজেক্টের টাইপ 'globalThis.MouseEvent' দেওয়া হয়েছে
    ...
    // ৩. এডভান্সড ক্লিনআপ এবং লিসেনার হ্যান্ডলিং
    const section = sectionRef.current;
    if (section) {
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 items-center">
          <div className="lg:col-span-7 text-white">
            <motion.h2 
              ...
              className="text-5xl md:text-8xl font-black mb-20 md:mb-28 tracking-tighter text-center md:text-left"
            >
            ...
            <div className="relative border-l-2 border-white/10 ml-4 md:ml-12">
              {eduData.map((edu, index) => (
                ...
                >
                  ...
                  >
                    <span className="text-[10px] text-gray-500 font-mono uppercase">Status / Subject</span>
          ...
          <div className="hidden lg:flex lg:col-span-5 justify-center">
            ...
            >
              ...
              <div className="relative z-10 w-full h-full rounded-[4rem] overflow-hidden border border-white/20 shadow-2xl">
                <Image 
                  src="/azharuleduction.jpg" 
                  alt="Md. Azharul Academic Journey"
                  fill
